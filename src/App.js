...
const Levels = [
  ...
  /* 23 */ {command: "Write a JavaScript function to create a table. Form with id='form1' has 2 fields, row count with id='row1' and column count with id='col1'. It has also a button 'Create table' with id='create'. Nest table in <div> with id='table-container'. Form with id='form2' has 3 fields, row with id='row2', column with id='col2', and value with id='val'. It has a button 'Insert' with id='insert'. If the table is out of range, it should print the proper message 'out of range' in <p> with id='err' element.",code:"// write your code here",protected_lines:0,vars:"",checks:[{msg:"Check for table creation",eval:`const createButton = document.getElementById('create');const row1 = document.getElementById('row1');const col1 = document.getElementById('col1');row1.value = 3;col1.value = 4;createButton.click();const container = document.getElementById('table-container');return container.querySelector('table') !== null;`,},{msg:"Check for data insert",eval:`const insertButton = document.getElementById('insert');const val = document.getElementById('val');const row2 = document.getElementById('row2');const col2 = document.getElementById('col2');val.value = 'Test';row2.value = 1;col2.value = 1;insertButton.click();const container = document.getElementById('table-container');const table = container.querySelector('table');return container.querySelector('table') === null ? false : table.rows[0].cells[0].innerText === 'Test';`,},{msg:"Check for error trigger",eval:`const insertButton = document.getElementById('insert');const row2 = document.getElementById('row2');row2.value = 'invalid';insertButton.click();const errMessage = document.getElementById('err');return errMessage.innerText === 'out of range';`,}],page_content:(<div id="sample-page"><form id="form1"><label htmlFor="row1">Row Count:</label><input type="number" id="row1" name="row1" required /><label htmlFor="col1">Column Count:</label><input type="number" id="col1" name="col1" required /><button type="button" id="create">Create Table</button></form><form id="form2"><label htmlFor="row2">Row:</label><input type="number" id="row2" name="row2" required /><label htmlFor="col2">Column:</label><input type="number" id="col2" name="col2" required /><label htmlFor="val">Value:</label><input type="text" id="val" name="val" required /><button type="button" id="insert">Insert</button></form><p id="err"></p><div id="table-container"></div></div>),},
]
